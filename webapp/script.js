document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateUI() {
        ...
        COLORS.forEach(c => {
            ...
            item.innerHTML = `
                <div class="color-dot" style="background:${COLOR_MAP[c]}"></div>
        ...
        flatCentre.sort((a,b) => a.num - b.num).forEach(item => {
            ...
            p.className = 'pion';
            p.style.backgroundColor = COLOR_MAP[item.color];
            p.textContent = item.num;
    ...
    startBtn.addEventListener('click', () => {
        ...
        winJ1Btn.textContent = `${state.nom1} a gagné`;
        winJ2Btn.textContent = `${state.nom2} a gagné`;
